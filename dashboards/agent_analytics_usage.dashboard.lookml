- dashboard: agent_analytics_usage
  ...
  - name: nav_header_sessions
    type: text
    title_text: ""
    body_text: "### [🏠 APO Executive Portal](/dashboards/japac_pso_agent_analytics_model::pso_apo_executive_portal) &nbsp;&nbsp;|&nbsp;&nbsp; [📈 Performance Dashboard](/dashboards/japac_pso_agent_analytics_model::agent_analytics_performance) &nbsp;&nbsp;|&nbsp;&nbsp; [📊 Usage Dashboard](/dashboards/japac_pso_agent_analytics_model::agent_analytics_usage)"
    row: 0
    col: 0
    width: 24
    height: 2
