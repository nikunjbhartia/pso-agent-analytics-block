view: v_llm_response {
  ...
  dimension: usage_prompt_tokens {
    group_label: "Token Usage"
    description: "What: The number of tokens consumed by the input prompt sent to the LLM.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    type: number
  ...
  dimension: usage_completion_tokens {
    group_label: "Token Usage"
    description: "What: The number of tokens consumed by the output generated by the LLM.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    type: number
  ...
  dimension: context_cache_hit_rate {
    group_label: "Token Usage"
    description: "What: The percentage of the prompt that was served from the cache (cached tokens / total prompt tokens).\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    type: number
  ...
  dimension: total_ms {
    group_label: "Latency"
    description: "What: The total wall-clock time in milliseconds the LLM took to process the request and generate the full response.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    type: number
    sql: ${TABLE}.total_ms ;;
  }
  ...
  dimension: ttft_ms {
    group_label: "Latency"
    description: "What: Time To First Token (TTFT). The latency in milliseconds before the LLM began streaming the first token of the response.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    type: number
    sql: ${TABLE}.ttft_ms ;;
  }
  ...
  dimension: model_version {
    group_label: "Event Info"
    description: "What: The specific version of the LLM model used for this request (e.g., 'gemini-2.5-flash').\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: string
  ...
  dimension: dynamic_tier_signal {
    ...
    description: "What: Recommends model tier migration based on real-time caching economics (STAY_PRO_CACHED vs MIGRATE_FLASH).\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    type: string
  ...
  measure: total_tokens_consumed {
    ...
    description: "What: Total tokens consumed across all LLM responses in the selected timeframe.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
  ...
  measure: total_prompt_tokens {
    ...
    description: "What: Total prompt tokens consumed across all LLM responses.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    drill_fields: [agent_events.timestamp_time, agent_events.agent, agent_events.user_id, agent_events.trace_id, model_version, total_ms]
  }
  ...
  measure: total_completion_tokens {
    ...
    description: "What: Total completion (candidate) tokens generated across all LLM responses.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    drill_fields: [agent_events.timestamp_time, agent_events.agent, agent_events.user_id, agent_events.trace_id, model_version, total_ms]
  }
  ...
  measure: total_llm_calls {
    ...
    type: count_distinct
    sql: ${pk} ;;
    description: "What: Total number of successful LLM responses.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    drill_fields: [agent_events.timestamp_time, agent_events.agent, agent_events.user_id, agent_events.trace_id, model_version, total_ms]
  ...
  measure: average_llm_latency {
    ...
    type: average
    sql: ${total_ms} ;;
    description: "What: Average latency for LLM responses in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
  ...
  measure: p50_llm_latency {
    ...
    percentile: 50
    sql: ${total_ms} ;;
    description: "What: Median (P50) latency for LLM responses in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  ...
  measure: p75_llm_latency {
    ...
    percentile: 75
    sql: ${total_ms} ;;
    description: "What: 75th percentile latency for LLM responses in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  }
  ...
  measure: p90_llm_latency {
    ...
    percentile: 90
    sql: ${total_ms} ;;
    description: "What: 90th percentile latency for LLM responses in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  ...
  measure: p99_llm_latency {
    ...
    percentile: 99
    sql: ${total_ms} ;;
    description: "What: 99th percentile latency for LLM responses in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  ...
  measure: pop_total_tokens_current {
    ...
    description: "What: Total tokens consumed in the currently selected PoP date range.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_total_tokens_previous {
    ...
    description: "What: Total tokens consumed in the previous period of the exact same length.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_total_tokens_change {
    ...
    description: "What: The percentage change in total tokens between the current and previous period.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_prompt_tokens_current {
    ...
    sql: ${usage_prompt_tokens} ;;
    filters: [agent_events.is_current_period: "yes"]
    description: "What: Total prompt tokens consumed in the currently selected PoP date range.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_prompt_tokens_previous {
    ...
    sql: ${usage_prompt_tokens} ;;
    filters: [agent_events.is_previous_period: "yes"]
    description: "What: Total prompt tokens consumed in the previous period.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_prompt_tokens_change {
    ...
    description: "What: The percentage change in prompt tokens between the current and previous period.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_completion_tokens_current {
    ...
    sql: ${usage_completion_tokens} ;;
    filters: [agent_events.is_current_period: "yes"]
    description: "What: Total completion tokens generated in the currently selected PoP date range.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_completion_tokens_previous {
    ...
    sql: ${usage_completion_tokens} ;;
    filters: [agent_events.is_previous_period: "yes"]
    description: "What: Total completion tokens generated in the previous period.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_completion_tokens_change {
    ...
    description: "What: The percentage change in completion tokens between the current and previous period.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
  }
  ...
  measure: pop_llm_calls_current {
    ...
    sql: ${pk} ;;
    filters: [agent_events.is_current_period: "yes"]
    description: "What: Total LLM calls in the currently selected PoP date range.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
  }
  ...
  measure: pop_llm_calls_previous {
    ...
    sql: ${pk} ;;
    filters: [agent_events.is_previous_period: "yes"]
    description: "What: Total LLM calls in the previous period.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
  }
  ...
  measure: pop_llm_calls_change {
    ...
    description: "What: The percentage change in LLM calls between the current and previous period.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
  }
  ...
  measure: total_spend_usd {
    group_label: "Executive FinOps Spend"
    description: "What: Total actual dollar spend USD applying a 75% discount for Gemini Prompt Caching ($1.25/M standard prompt, $0.3125/M cached prompt, $5.00/M completion).\nHow: Calculated using Gemini 2.5 Pro pricing rates with 75% prompt cache discount ($0.3125/M cached vs $1.25/M standard input).\nWhy: Monitors net FinOps API expenditure and identifies opportunities for prompt cache optimization."
    type: number
  ...
  measure: cost_per_session_usd {
    group_label: "Executive FinOps Spend"
    description: "What: Unit economics: average dollar cost per customer session.\nHow: Calculated using Gemini 2.5 Pro pricing rates with 75% prompt cache discount ($0.3125/M cached vs $1.25/M standard input).\nWhy: Monitors net FinOps API expenditure and identifies opportunities for prompt cache optimization."
    type: number
    value_format_name: usd
  ...
  measure: cache_hit_ratio_pct {
    group_label: "Executive FinOps Spend"
    description: "What: Percentage of prompt tokens served directly from Gemini Prompt Caching.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    type: number
    value_format_name: percent_2
  ...
  measure: cache_savings_usd {
    group_label: "Executive FinOps Spend"
    description: "What: Estimated dollar savings from Gemini prompt caching.\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    type: number
    value_format_name: usd
  ...
  measure: cache_discounted_actual_cost_usd {
    group_label: "Executive FinOps Spend"
    description: "What: Total actual dollar spend USD applying Gemini prompt caching discount ($1.25/M standard prompt vs $0.3125/M cached prompt vs $5.00/M completion).\nHow: Calculated using Gemini 2.5 Pro pricing rates with 75% prompt cache discount ($0.3125/M cached vs $1.25/M standard input).\nWhy: Monitors net FinOps API expenditure and identifies opportunities for prompt cache optimization."
    type: number
    value_format_name: usd
    sql: ROUND(SUM(
  ...
  measure: prompt_cache_hit_ratio {
    group_label: "Executive FinOps Spend"
    description: "What: Ratio of prompt tokens served from cache (0.0 to 1.0).\nHow: SUM of token count fields extracted from LLM usage metadata.\nWhy: Tracks context window consumption and prompt engineering efficiency across agent workflows."
    type: number
    value_format_name: percent_2
    sql: SAFE_DIVIDE(SUM(${usage_cached_tokens}), NULLIF(SUM(${usage_prompt_tokens}), 0)) ;;
  }
