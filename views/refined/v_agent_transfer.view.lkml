view: v_agent_transfer {
  ...
  dimension: from_agent {
    ...
    description: "The originating agent in a multi-agent transfer."
    type: string
  ...
  dimension: to_agent {
    group_label: "Multi-Agent Delegation"
    description: "The target receiving agent in a multi-agent transfer."
    type: string
    sql: ${TABLE}.to_agent ;;
  }
  ...
  measure: total_agent_transfers {
    ...
    group_label: "Multi-Agent Delegation"
    description: "Total number of multi-agent handoffs or delegation events."
    type: count
  }
}
