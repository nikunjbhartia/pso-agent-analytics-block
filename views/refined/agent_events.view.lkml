view: agent_events {
  ...
  measure: total_events {
    ...
    link: {
      ...
      url: "{% assign vis_config = '{ \"type\": \"looker_bar\", \"x_axis_gridlines\": false, \"y_axis_gridlines\": true, \"show_view_names\": false, \"show_y_axis_labels\": true, \"show_y_axis_ticks\": true, \"y_axis_tick_density\": \"default\", \"show_x_axis_label\": true, \"show_x_axis_ticks\": true, \"y_axis_scale_mode\": \"linear\", \"legend_position\": \"center\", \"show_value_labels\": false, \"series_colors\": { \"agent_events.total_events\": \"#137333\" }, \"defaults_version\": 1 }' %}{{ link }}&fields={{ _view._name }}.total_events,agent_events.user_id&sorts={{ _view._name }}.total_events+desc&limit=10&column_limit=50&vis_config={{ vis_config | encode_uri }}&toggle=dat,pik,vis"
    }
    link: {
