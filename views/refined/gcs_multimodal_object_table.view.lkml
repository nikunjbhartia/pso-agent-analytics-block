view: gcs_multimodal_object_table {
  ...
  dimension: uri {
    ...
    description: "What: What: Google Cloud Storage object URI in bucket japac-pso-agent-analytics. How: Direct reference from BigQuery Object Table gcs_multimodal_object_table. Why: Identifies the exact GCS storage asset.\nHow: Extracted from canonical telemetry attribution metadata across Google Cloud PSO JAPAC engagements.\nWhy: Enables granular multi-dimensional filtering, cohort comparison, and adoption leaderboards."
    type: string
    sql: ${TABLE}.uri ;;
  }
  ...
  dimension: content_type {
    ...
    group_label: "BigQuery GCS Object Table"
    description: "What: What: MIME type of the offloaded GCS object (image/png, application/pdf, application/json, etc.). How: Extracted from GCS SIMPLE object metadata. Why: Categorizes multimodal offload storage by file type.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: string
  ...
  dimension: asset_type {
    ...
    group_label: "BigQuery GCS Object Table"
    description: "What: What: High-level asset category (IMAGE, DOCUMENT, AUDIO, VIDEO, LARGE_PAYLOAD_JSON). How: Derived from content_type MIME string in object table. Why: Monitors storage footprint by modality.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: string
    sql: CASE
  ...
  measure: total_object_count {
    ...
    group_label: "BigQuery GCS Object Table"
    description: "What: What: Count of files stored in GCS bucket japac-pso-agent-analytics. How: COUNT of object table rows. Why: Tracks physical GCS bucket object inventory.\nHow: Extracted from canonical telemetry attribution metadata across Google Cloud PSO JAPAC engagements.\nWhy: Enables granular multi-dimensional filtering, cohort comparison, and adoption leaderboards."
    type: count
  }
