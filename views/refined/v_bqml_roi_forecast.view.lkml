view: v_bqml_roi_forecast {
  ...
  dimension: data_type {
    ...
    description: "What: Indicates whether the data point is a historical ACTUAL or a 30-DAY FORECAST prediction. | How: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry. | Why: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: string
    sql: ${TABLE}.data_type ;;
  }
  ...
  measure: predicted_hours_saved {
    ...
    group_label: "BigQuery AI Forecast"
    description: "What: Estimated manual engineering hours saved. Rationale: Historical actuals use total_sessions * 3.5 hrs (PSO pilot benchmark). Future 30-day predictions use linear growth projection. | How: Empirically calculated using Google Cloud PSO pilot benchmarks (sessions * 3.5 hrs, $350/hr billable rate). | Why: Quantifies executive ROI, workforce FTE capacity creation, and billable consulting value."
    type: sum
  ...
  measure: predicted_consulting_value_usd {
    ...
    group_label: "BigQuery AI Forecast"
    description: "What: Predicted dollar consulting value created. Rationale: Values each predicted hour saved at the standard Google Cloud PSO JAPAC billable rate of $350/hr ($2,800/day Consultant rate). | How: Empirically calculated using Google Cloud PSO pilot benchmarks (sessions * 3.5 hrs, $350/hr billable rate). | Why: Quantifies executive ROI, workforce FTE capacity creation, and billable consulting value."
    type: sum
  ...
  measure: confidence_lower_bound_hours {
    ...
    group_label: "BigQuery AI Forecast"
    description: "What: Lower confidence interval bound for predicted engineering hours saved. | How: Empirically calculated using Google Cloud PSO pilot benchmarks (sessions * 3.5 hrs, $350/hr billable rate). | Why: Quantifies executive ROI, workforce FTE capacity creation, and billable consulting value."
    type: sum
    value_format_name: decimal_1
  ...
  measure: confidence_upper_bound_hours {
    ...
    group_label: "BigQuery AI Forecast"
    description: "What: Upper confidence interval bound for predicted engineering hours saved. | How: Empirically calculated using Google Cloud PSO pilot benchmarks (sessions * 3.5 hrs, $350/hr billable rate). | Why: Quantifies executive ROI, workforce FTE capacity creation, and billable consulting value."
    type: sum
    value_format_name: decimal_1
