view: v_tool_completed {
  ...
  dimension: tool_name {
    ...
    description: "What: The specific name of the tool or function that was executed.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: string
    sql: ${TABLE}.tool_name ;;
  }
  ...
  dimension: tool_origin {
    group_label: "Tool Info"
    description: "What: The origin of the tool execution (e.g., LOCAL, MCP, SUB_AGENT).\nHow: Extracted from canonical telemetry attribution metadata across Google Cloud PSO JAPAC engagements.\nWhy: Enables granular multi-dimensional filtering, cohort comparison, and adoption leaderboards."
    type: string
  ...
  dimension: tool_result {
    group_label: "Tool Info"
    description: "What: The raw JSON result or output string returned by the tool.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: string
  ...
  dimension: total_ms {
    group_label: "Latency"
    description: "What: The total execution time of the tool in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    type: number
    sql: ${TABLE}.total_ms ;;
  }
  ...
  measure: total_tool_usage {
    ...
    type: count_distinct
    sql: ${pk} ;;
    description: "What: Total number of times a tool was successfully completed.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
  ...
  measure: average_tool_latency {
    ...
    type: average
    sql: ${total_ms} ;;
    description: "What: Average latency for tool completion in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
  ...
  measure: p50_tool_latency {
    ...
    percentile: 50
    sql: ${total_ms} ;;
    description: "What: Median (P50) latency for tool completion in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  ...
  measure: p75_tool_latency {
    ...
    percentile: 75
    sql: ${total_ms} ;;
    description: "What: 75th percentile latency for tool completion in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  }
  ...
  measure: p90_tool_latency {
    ...
    percentile: 90
    sql: ${total_ms} ;;
    description: "What: 90th percentile latency for tool completion in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  ...
  measure: p99_tool_latency {
    ...
    percentile: 99
    sql: ${total_ms} ;;
    description: "What: 99th percentile latency for tool completion in milliseconds.\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    drill_fields: []
  ...
  measure: pop_tool_usage_current {
    ...
    description: "What: Total tool executions in the currently selected PoP date range.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
  }
  ...
  measure: pop_tool_usage_previous {
    ...
    description: "What: Total tool executions in the previous period of the exact same length.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
  }
  ...
  measure: pop_tool_usage_change {
    ...
    description: "What: The percentage change in tool executions between the current and previous period.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
  }

  measure: tool_productivity_credit_hours {
    group_label: "Usage & Volume"
    description: "What: Total server-verified productivity credit hours saved by tool completions. Estimation Note: Assumes 1.5 hrs baseline manual effort saved per tool call, scaled by latency complexity weight (1.0x standard, 1.5x >2s, 2.5x >5s).\nHow: Measured in milliseconds from start timestamp to completion timestamp across trace spans.\nWhy: Identifies slow tool execution bottlenecks and ensures end-user conversational responsiveness."
    type: number
  ...
  measure: avg_complexity_multiplier {
    group_label: "Performance & Reliability"
    description: "What: Average complexity multiplier across executed tools.\nHow: Evaluated via LookML SQL extraction or aggregation over BigQuery agent_events telemetry.\nWhy: Essential for JAPAC PSO agent performance monitoring, FinOps cost attribution, and reliability SLA gating."
    type: average
